...
<body>
    ...
    <script>
        var editarModal = document.getElementById('editarModal'); // Corregido el ID
        ...
        verModal.addEventListener('show.bs.modal', function (event) {
            ...
            xhr.open("GET", "obtener_propietarios.php?catastro_id=" + encodeURIComponent(idCatastro), true);
            xhr.onload = function() {
                if (xhr.status === 200) {
